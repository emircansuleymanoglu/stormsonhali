    ...
    <>
      <section className="relative overflow-hidden bg-[#0d1524] text-white">
        ...
        <div className="container-shell relative grid min-h-[calc(100vh-96px)] content-center py-20 sm:py-24">
          <div className="w-full max-w-[720px] animate-rise text-left sm:ml-4 lg:ml-0 lg:max-w-[700px] xl:max-w-[720px]">
              ...
              <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                <div>
                  <p className="text-xs font-black uppercase text-white/50">
                    Premium transport standard
                  </p>
                  <p className="mt-1 max-w-md text-sm font-bold text-white/82">
                    Vaste werkwijze voor transport, opslag en distributie met
                    heldere overdracht per zending.
                  </p>
                </div>
                <div className="quality-seal grid size-16 shrink-0 place-items-center rounded-lg border border-[#79d0ff]/35 bg-[#79d0ff]/12 text-[#79d0ff]">
                  <ShieldCheck size={30} />
                </div>
              </div>
              <div className="quality-flow mt-5">
                <span />
                <span />
                <span />
              </div>
